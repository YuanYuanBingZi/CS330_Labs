/*************************************
CIS 330 Lab 8: Operator overloading, namespaces, and static members
...
namespace Mem {
  ...
  public:
    ...
    friend std::ostream
    friend int holy();
    IntQueue & operator<<(int inData) {Enqueue(inData);}
    IntQueue & operator>>(int &outData) {outData = Dequeue();}
